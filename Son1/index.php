...
<head>
    ...
    <link href="./css/bodyHome.css" rel="stylesheet">
...
<body >
    ...
    <section>
        <div class="square">
            ...
            <span></span>
            <div class="content">
                <h2>قصتك الاستثنائية تبدأ الآن</h2>
                <a href="Countries.php">تصفح</a>
				<a>مرحبا <?php echo $_SESSION['username']; ?>!</a>
                <!--a href="sign.html">تسجيل</a-->
            </div>
        </div>
